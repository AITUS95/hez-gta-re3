...
enum
{
	...
	NUM_COLOMBIAN_GARAGE_STORED_CARS = NUM_GARAGE_STORED_CARS,
	MAX_COLOMBIAN_GARAGE_STORED_CARS = 2
};
...
public:
	...
	static CStoredCar aCarsInColombianGarage[NUM_COLOMBIAN_GARAGE_STORED_CARS];
