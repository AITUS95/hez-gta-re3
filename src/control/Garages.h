...
enum
{
	...
	NUM_CORLEONE_GARAGE_STORED_CARS = NUM_GARAGE_STORED_CARS,
	MAX_CORLEONE_GARAGE_STORED_CARS = 2
};
...
public:
	...
	static CStoredCar aCarsInCorleoneGarage[NUM_CORLEONE_GARAGE_STORED_CARS];
